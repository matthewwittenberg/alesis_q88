...
3. Debugging is a little slow compared to other toold but it works so be patient between starting to debugging and hitting main().
## Misc
...
4. Key response (velocity) needs work.
5. Add commenting.
6. Expression pedal.
7. Directional/transport button support (buttons work but not handled).
## Code
