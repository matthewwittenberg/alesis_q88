...
extern void midi_usb_controller(uint8_t index, uint8_t channel, uint8_t value);
...
extern void midi_serial_controller(uint8_t index, uint8_t channel, uint8_t value);
