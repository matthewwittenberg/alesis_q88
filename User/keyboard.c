...
void keyboard_init()
{
	...
	// set key pins high
	GPIO_PIN_DATA(KEYBOARD_KEY1_PORT_VAL, KEYBOARD_KEY1_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY2_PORT_VAL, KEYBOARD_KEY2_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY3_PORT_VAL, KEYBOARD_KEY3_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY4_PORT_VAL, KEYBOARD_KEY4_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY5_PORT_VAL, KEYBOARD_KEY5_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY6_PORT_VAL, KEYBOARD_KEY6_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY7_PORT_VAL, KEYBOARD_KEY7_PIN) = 1;
	GPIO_PIN_DATA(KEYBOARD_KEY8_PORT_VAL, KEYBOARD_KEY8_PIN) = 1;
...
void keyboard_task()
{
	scan_keys(KEYBOARD_DETECT_GROUP1_PORT_VAL, KEYBOARD_DETECT_GROUP1_PIN, KEYBOARD_PRESS_GROUP1_PORT_VAL, KEYBOARD_PRESS_GROUP1_PIN, 1);
	scan_keys(KEYBOARD_DETECT_GROUP2_PORT_VAL, KEYBOARD_DETECT_GROUP2_PIN, KEYBOARD_PRESS_GROUP2_PORT_VAL, KEYBOARD_PRESS_GROUP2_PIN, 2);
	scan_keys(KEYBOARD_DETECT_GROUP3_PORT_VAL, KEYBOARD_DETECT_GROUP3_PIN, KEYBOARD_PRESS_GROUP3_PORT_VAL, KEYBOARD_PRESS_GROUP3_PIN, 3);
	scan_keys(KEYBOARD_DETECT_GROUP4_PORT_VAL, KEYBOARD_DETECT_GROUP4_PIN, KEYBOARD_PRESS_GROUP4_PORT_VAL, KEYBOARD_PRESS_GROUP4_PIN, 4);
	scan_keys(KEYBOARD_DETECT_GROUP5_PORT_VAL, KEYBOARD_DETECT_GROUP5_PIN, KEYBOARD_PRESS_GROUP5_PORT_VAL, KEYBOARD_PRESS_GROUP5_PIN, 5);
	scan_keys(KEYBOARD_DETECT_GROUP6_PORT_VAL, KEYBOARD_DETECT_GROUP6_PIN, KEYBOARD_PRESS_GROUP6_PORT_VAL, KEYBOARD_PRESS_GROUP6_PIN, 6);
	scan_keys(KEYBOARD_DETECT_GROUP7_PORT_VAL, KEYBOARD_DETECT_GROUP7_PIN, KEYBOARD_PRESS_GROUP7_PORT_VAL, KEYBOARD_PRESS_GROUP7_PIN, 7);
	scan_keys(KEYBOARD_DETECT_GROUP8_PORT_VAL, KEYBOARD_DETECT_GROUP8_PIN, KEYBOARD_PRESS_GROUP8_PORT_VAL, KEYBOARD_PRESS_GROUP8_PIN, 8);
